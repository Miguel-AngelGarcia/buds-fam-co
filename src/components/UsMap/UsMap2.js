...
export const UsMap = () => {
  ...
  const clickedStyle =
    "{fill: 'rgb(153, 137, 178)', transform: 'scale(0.999)', stroke: '#000000', strokeWidth: '1.5'}";
      ...
      >
        ...
        <g id="g5">
          <path
            ...
            onClick={(e) => stateUsStateClick(e.target.id)}
            style={{
          ...
          <path
            id="AK"
            data-info="<div>State: Alaska</div><div>Capital: Acnhorage</div>"
            onClick={(e) => stateUsStateClick(e.target.id)}
